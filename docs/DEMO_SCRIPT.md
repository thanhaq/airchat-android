...
22. Open diagnostics and show transport/key/power/courier status plus recent events.
...
- "Power modes make battery saver visible and reduce relay churn before Android kills background work."
