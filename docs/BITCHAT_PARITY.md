...
| Diagnostics | Protocol whitepaper and build verification guidance. | In-app diagnostics report, privacy-preserving recent event log, share action, compare scripts, release manifest, launch status, and field-test template. |
