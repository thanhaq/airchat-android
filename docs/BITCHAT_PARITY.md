...
| Identity verification | QR verification binds nickname to fingerprint. | Safety-number compare, QR/shareable safety cards, signed trust backups, trust records, and key-change protection. |
